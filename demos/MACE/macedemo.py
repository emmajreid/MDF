...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='dncnn_25.pth', type=str, help='the model name')
    ...
    parser.add_argument('forwards', nargs = '*', default = [0]) # 0 is for AT, 1 for bicubic
